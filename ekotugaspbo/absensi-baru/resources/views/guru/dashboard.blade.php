...
<div class="container-fluid px-4">
    <div class="row">
        ...
        <div class="col-md-3 mb-4">
            {{-- Menggunakan sidebar yang sudah dipisah --}}
        ...
        <div class="col-md-9">
            ...
            <div class="card border-0 shadow-sm mt-4 p-4" style="border-radius: 15px;">
                <h5 class="fw-bold">Selamat Datang, Bapak/Ibu {{ Auth::user()->name }}!</h5>
                <p class="text-muted mb-0">Anda masuk dengan hak akses <strong>Guru</strong>. Silakan pantau absensi siswa dan data perizinan melalui menu navigasi.</p>
            </div>
